...
draft: false
heroImage:
  url: "/blog/mcp-auth-audit-logging-laravel/hero.svg"
  alt: "Neo illustration of an MCP session gate in front of a Laravel lock"
---
...
![Actor context flowing from AI agent through locked MCP tools into Laravel domain services](/blog/mcp-auth-audit-logging-laravel/actor-flow.svg)
...
![Comic audit log console showing ALLOWED get_invoice and DENIED refund_order rows](/blog/mcp-auth-audit-logging-laravel/audit-log.svg)
