...
draft: false
heroImage:
  url: "/blog/mcp-auth-audit-logging-laravel/hero.webp"
  alt: "Comic pop-art hero: Laravel MCP auth gate, tenant isolation, and audit ticker"
---
...
![Actor context flowing from AI agent through locked MCP tools into Laravel domain services](/blog/mcp-auth-audit-logging-laravel/actor-flow.webp)
...
![Comic audit log console showing ALLOWED get_invoice and DENIED refund_order rows](/blog/mcp-auth-audit-logging-laravel/audit-log.webp)
