...
description: "Stop running embeddings in the request cycle. A document ingestion pipeline with staged workers, backoff, dead-letter queues, and queue-depth autoscaling."
