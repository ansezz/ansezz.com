---
title: "Shopify Storefront Web Components: headless for everyone"
...
Here is the part where it gets interesting for modern developers. Shopify has released a specific [llms.txt](https://webcomponents.shopify.dev/llms.txt) file.
