...
Here is the part where it gets interesting for modern developers. Shopify publishes a machine-readable [llms.txt](https://webcomponents.shopify.dev/llms.txt) for Storefront Web Components.
