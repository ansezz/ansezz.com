---
title: "LLM vs AI agent: from prompts to action"
...
heroImage:
  ...
  alt: "Pop-art comic of a brain wired up with tools and memory, illustrating an LLM becoming an AI agent"
---
...
![Bento grid showing the four pillars that turn an LLM into an AI agent: memory, tools, planning, and reasoning](/blog/llm-vs-ai-agent/agency-pillars.webp)
...
Agentic RAG takes this further. Instead of a fixed retrieval step, the agent decides _when_ to search, _what_ keywords to use, and _whether_ the retrieved information was actually useful. If the first search results are poor, the agent refines its query and searches again. I cover this evolution in more depth in [traditional vs agentic vs corrective RAG](/blog/rag-architectures-traditional-agentic-corrective/).

![Circular diagram of an AI agent's reasoning loop: think, act with a tool, then observe the result before deciding the next step](/blog/llm-vs-ai-agent/reasoning-loop.webp)
