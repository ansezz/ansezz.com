...
heroImage:
  ...
  alt: "Pop-art dashboard contrasting a CI build-and-test panel with a CD release panel in a bento grid"
---
...
![Pop-art bento grid showing the build, test, and deploy stages of a CI/CD pipeline flowing left to right](/blog/ci-vs-cd/pipeline-stages.webp)
...
**Continuous Deployment** takes this a step further by removing the manual trigger. Every change that passes the pipeline is automatically pushed to the production environment. This demands deep confidence in your test suite and the [observability to catch regressions fast](/blog/logging-vs-monitoring/) — without it, a bad commit reaches users before anyone notices.
...
![Pop-art code editor displaying a GitHub Actions workflow YAML file for a Laravel CI job](/blog/ci-vs-cd/github-actions-yaml.webp)
...
![Pop-art scene of a Shopify theme deployment dashboard on a tablet showing a published theme swap](/blog/ci-vs-cd/shopify-deploy.webp)
