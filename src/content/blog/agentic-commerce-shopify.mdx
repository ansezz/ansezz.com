...
The [Model Context Protocol (MCP)](/blog/mcp-context-aware-agents/) lets us connect AI models to external data sources like the Shopify API — and it's the same binding UCP uses to expose commerce tools to agents.
