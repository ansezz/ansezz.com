...
If the team over-fetches GraphQL data, hydrates too much JavaScript, or ships a bloated component tree, the custom storefront can end up slower than a decent Liquid theme. That happens more often than people admit. There is also a middle path worth knowing about: dropping in [Shopify storefront web components](/blog/shopify-storefront-web-components/) lets you add dynamic, framework-light interactivity without committing to a full headless rebuild.
