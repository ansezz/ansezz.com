...
Retrieval-augmented generation (RAG) is the most common implementation of context engineering. It solves the "knowledge gap" by connecting your LLM to a vector store — Postgres with the [pgvector extension](/blog/picking-the-right-rag-stack/), or a dedicated database like Pinecone, Weaviate, or Qdrant.
...
2. **Invest in RAG early.** A vector store like Postgres with pgvector gives you a scalable way to handle growing documentation and data.
