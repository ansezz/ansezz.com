...
description: "Data engineer vs data scientist: who builds the pipelines, who builds the models, where the tools overlap, and which role your AI project needs first."
...
![Pop-art diagram of a data pipeline flowing from sources through a warehouse to models, showing where engineers and scientists hand off](/blog/data-engineer-vs-data-scientist/data-architecture.webp)

## The synergy in modern AI stacks

In the era of LLMs and generative AI, the lines between these roles are becoming more blurred, yet the need for specialization is higher than ever. A similar boundary is being redrawn between the [ML engineer and the AI engineer](/blog/ml-engineer-vs-ai-engineer/). Consider a Retrieval-Augmented Generation (RAG) system.

The Data Engineer builds the ingestion pipeline that scrapes documentation, cleans the text, generates embeddings, and stores them in a vector database like pgvector. They ensure the [API gateway](/blog/api-gateway-ai-stack/) is secure and that the index stays fresh, whether through scheduled batch jobs or near-real-time streaming.
