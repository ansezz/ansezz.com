---
title: "From monolith to microservices: a pragmatic scaling guide"
description: "Skip the big-bang rewrite. The strangler fig pattern, anti-corruption layers, and Docker-first migration to peel services off a Laravel monolith safely."
...
The process starts with an API gateway or a load balancer. I use [Nginx](https://www.nginx.com/) or [Cloud Armor](https://cloud.google.com/armor) on [Google Cloud](https://cloud.google.com/) to route traffic. If a request comes for `/api/v1/orders`, it goes to the new service. Everything else goes to the old monolith.
