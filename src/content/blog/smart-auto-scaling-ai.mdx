...
description: "CPU autoscaling fails GPU workloads. Why queue depth, KV-cache pressure, and TTFT beat CPU as triggers — KEDA patterns that scale AI before users see a spinner."
