...
featured: false
heroImage:
  url: "/blog/ai-coding-workflow-levels/hero-26647505.webp"
...
![Technical pop-art illustration showing an AI coding workflow evolving from chat prompts to Laravel and Shopify GraphQL agents](/blog/ai-coding-workflow-levels/workflow-evolution-5d257c12.webp)
...
![Vibrant pop-art bento grid diagram of an agentic system wiring MCP servers, pgvector memory, and deployment agents](/blog/ai-coding-workflow-levels/agentic-system-ef9b1ff6.webp)
...
public function updateProductInventory(string $inventoryItemId, int $newQuantity)
{
    ...
    $variables = [
        ...
        'input' => [
            'name' => 'available',
            'reason' => 'correction',
            // Required on current Admin API: compare-and-set. null skips the check.
            'quantities' => [
                [
